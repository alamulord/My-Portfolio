...
const WORK_LOCATION = {
  ...
  children: [
    // ▶ Project 1
    {
      ...
      windowPosition: 'top-[5vh] left-5', // stacked left
      children: [
        {
          id: 1,
    ...
    // ▶ Project 2
    {
      ...
      windowPosition: 'top-[14vh] left-3',
      children: [
        {
          id: 1,
        ...
        },
        {
          ...
          imageUrl: '/images/payshieldLandingPage.png',
        },
        {
          id: 5,
          name: 'overview.png',
    ...
    // ▶ Project 3
    {
      ...
      windowPosition: 'top-[25vh] left-3',
      children: [
        {
          id: 1,
    ...
    // project 4
    {
      ...
      children: [
        {
          id: 1,
          name: 'StudyBuddy AI Project.txt',
          icon: '/images/txt.png',
          kind: 'file',
          fileType: 'txt',
          position: 'top-5 left-10',
          description: [
            'StudyBuddy AI is a platform that helps students archive learning goals by simulating complex task into manageable steps.',
            'It’s helps students summarize notes, generate flashcards, and create quizzes to test their knowledge.',
            'It’s built with React and Tailwind, so it works smoothly on both iOS and Android with a clean, modern design.',
          ],
        },
        {
          id: 2,
          name: 'study-buddy-ai.vercel.app',
          icon: '/images/safari.png',
          kind: 'file',
          fileType: 'url',
        ...
        {
          id: 4,
          name: 'StudyBuddy-Dashboard.jpeg',
          icon: '/images/image.png',
          kind: 'file',
          fileType: 'img',
          position: 'top-52 right-80',
          imageUrl: '/images/studyBuddyDashboard.png',
        },
        {
          id: 5,
          name: 'studyBuddyFlashcard.png',
          icon: '/images/image.png',
          kind: 'file',
          fileType: 'img',
          href: 'https://google.com',
          position: 'top-60 right-20',
          imageUrl: '/images/studyBuddyFlashcard.png',
        },
      ],
    },
    // project 5
